            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, new Promise(function (resolve, reject) {
                            ...
                            spinner.start();
                            (0, download_git_repo_1.default)('direct:http://gitlab.prod.dtstack.cn/visdev/easyvadmin-monorepo.git', path_1.default.resolve(process.cwd(), _this.name), { clone: true }, function (error) {
                                if (error) {
